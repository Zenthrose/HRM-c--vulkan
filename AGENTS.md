...
- C++ Build (Windows): `set PATH=C:\msys64\mingw64\bin;%PATH% && mkdir build && cd build && cmake .. -DCMAKE_CXX_COMPILER=C:\msys64\mingw64\bin\g++.exe -DCMAKE_C_COMPILER=C:\msys64\mingw64\bin\gcc.exe && cmake --build . --config Release -j 2`
